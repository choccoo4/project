...
<div class="min-h-screen bg-[#FFF8F2] p-6">
  ...
  <header class="flex justify-between items-center mb-8 bg-white rounded-2xl shadow px-6 py-4">
    ...
    <div class="flex items-center gap-4">
      ...
      <p class="text-gray-800 text-lg">Halo, <b class="text-[#EB580C]">Admin</b></p>
    </div>
  </header>
  ...
  <div class="bg-white rounded-2xl shadow p-6 mt-8">
    ...
    <div class="flex justify-end mt-6">
      <button
        class="bg-[#FFB84C] hover:bg-[#FFA500] text-white font-semibold px-6 py-2 rounded-full shadow transition font-fredoka">
        Lihat Semua
      </button>
    </div>
  </div>
